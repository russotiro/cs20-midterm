...
function loadPurchaseForm() {
    ...
    document.getElementById("buy").innerHTML = "<form name=\"purchase-form\" action=\"\"> <label for=\"fname\">First name:</label><br> <input type=\"text\" id=\"fname\" name=\"fname\" value=\"\"><br> <label for=\"lname\">Last name:</label><br> <input type=\"text\" id=\"lname\" name=\"lname\" value=\"\"><br> <label for=\"email\">Enter your email:</label><br> <input type=\"email\" id=\"email\" name=\"email\"><br><br> <div class=\"center-holder\"><input type=\"button\" id=\"submit-button\" value=\"Purchase\" onclick=\"handlePurchase()\"></div> </form>"
}

function handlePurchase() {
    goodToGo = document.getElementById("email").validity.valid;
    if (goodToGo)
